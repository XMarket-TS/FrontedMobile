    ...
    return SafeArea(
        child: Scaffold(
          appBar: AppBar(
            ...
            elevation: 5,
            title: Text("Profile",style: TextStyle(fontSize: size.height*0.045),),
            centerTitle: true,
          ),
                            ...
                            GestureDetector(
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Text(
                                    "Editar Perfil",style: TextStyle(color: Colors.white,fontSize: size.height*0.028),
                                  ),
                                ),
                              ),
                            ),
                            GestureDetector(
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  padding: const EdgeInsets.only(top: 8, bottom: 8, right: 20,left: 20),
                                  child: Text(
                                    "Editar Tarjetas",style: TextStyle(color: Colors.white,fontSize: size.height*0.028),
                                  ),
                                ),
                              ),
                            ),
