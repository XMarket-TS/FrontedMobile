...
class CategoriesPage extends StatefulWidget {
  ...
  @override
  _CategoriesPageState createState() => _CategoriesPageState(this._listCategories,this._listOffer);
}
              ...
              return Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text("Categorias",style: TextStyle(color: Colors.white,fontSize: size.width*0.08),),
                    // categoriesScroller,
                    Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      child: Column(
                                        children: [
                                          Text("${_listCategories[index].name}",style: TextStyle(fontSize: 20.0,color: Colors.white),),
