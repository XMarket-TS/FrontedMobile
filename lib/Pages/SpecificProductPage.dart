...
import 'package:x_market/Repository/ListProductsRepository.dart';
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      height: size.height*0.28,margin: const EdgeInsets.symmetric(vertical:10,horizontal: 10),
                      child: ListView.builder(
                        scrollDirection: Axis.horizontal,
                          ...
                          return Card(
                            ...
                            child: Image.network(_product.imageUrl[index],fit:BoxFit.fill),
                          );
                          }
                      ),
                    ),
                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            children: [
                              ...
                              Text(_product.name,style: TextStyle(color: color2,fontSize: size.height*0.03),),
                              SizedBox(height: size.height*0.025,),
                              Text(_product.description,style: TextStyle(color: color5,fontSize: size.height*0.02),),
                              SizedBox(height: size.height*0.025,),
                              Row(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          Text("${_product.price.toString()} Bs",
                                            style: TextStyle(color: color5,fontWeight: FontWeight.bold,
                                                fontSize: size.height * 0.024),
                                          ),
                                        ],
                                    ...
                                    onTap: (){
                                      ...
                                      return showDialog(
                                        ...
                                        builder: (BuildContext context){
                                            return chooseProduct(size, _product, _units,_addProduct);
                                        }
                                      );
                                    },
                                    child: Container(
...
class chooseProduct extends StatefulWidget {
  ...
  @override
  _chooseProductState createState() => _chooseProductState(this.size,this._product,this._units,this._addProduct);
}
...
class _chooseProductState extends State<chooseProduct> {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      title: Container(
        ...
        decoration: BoxDecoration(
            ...
            image: DecorationImage(
                image: NetworkImage(_product.imageUrl[0]),
                fit: BoxFit.cover
            )
        ),
      ),
      ...
      content: Container(
          ...
          child: ScrollConfiguration(
            ...
            child: ListView(
              children: [
                SizedBox(height: size.height*0.025,),
                Text("Cantidad:",style: TextStyle(color: color5,fontSize: 18,fontWeight: FontWeight.w500),),
                Container(
                  color: color1,
                  child: TextField(
                    controller: _units,
                ...
                SizedBox(height: size.height*0.025,),
                Text("Precio:",style: TextStyle(color: color5,fontSize: 18,fontWeight: FontWeight.w500),),
                Text(_product.price.toString(),style: TextStyle(color: color5,fontSize: 20,fontWeight: FontWeight.w500),),
                // SizedBox(height: 10,),
      ...
      actions: <Widget>[
        TextButton(
          child: Text('Agregar',style: TextStyle(color: color4),),
          onPressed: () {
        ...
        TextButton(
          child: Text('Cancelar',style: TextStyle(color: color2),),
          onPressed: () {
              Navigator.of(context).pop();
          },
        ),
