...
//   //   Product(2,"Tomate",3.44,"Fresca, traida del tropico",4,['burger.png','cola.png'],1,"Vegetasles"),
...
//   Stream<List<Product>> get productListStream =>
//       _productListStreamController.stream;
//
//   StreamSink<List<Product>> get productListSink =>
//       _productListStreamController.sink;
//
//   StreamSink<Product> get productDecrement =>
//       _productDecrementStreamController.sink;
//
//   ProductBloc() {
//     //escucha cada que se llama a ProductBloc
